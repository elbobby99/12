...
$mensaje .="hoja de verificacion de equipo informatico " ."\r\n";
$mensaje .="FECHA" .$Fecha.",\r\n";
...
/*$mensaje .= "Se me entregaron todos sus accesorios" ."$Acessorios" . " \r\n";*/
...
$mensaje .= "Se realizo alguna instalación en el área de trabajo:"."$Instalacion_tra" . " \r\n";
$mensaje .= "En caso de haber respondido NO en algunas preguntas que el encargado de sistemas justifique la respuesta"."$Justi" . " \r\n";
