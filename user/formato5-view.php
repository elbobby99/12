<div class="container">
<h1>Hoja de verificación de equipo informático</h1>
  <div class="row">
    <div class="col-sm-8">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form role="form" action="./process/enviarfor5.php" method="POST">
            ...
            <div class="form-group">
              <label><i class="fa fa-male"></i>&nbsp;Nombre de la persona asigno el equipo</label>
