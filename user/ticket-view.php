                    ...
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <select class="form-control" name="departamento_ticket">
                                  ...
                                  <option value="Suminiestros">Suministro</option>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" rows="3" placeholder="Descripcion del problema que  presenta el equipo" name="mensaje_ticket" required=""></textarea>
                          </div>
                        </div>
